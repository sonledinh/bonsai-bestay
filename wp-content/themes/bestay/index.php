	...
	<section class="box-prd">
		<div class="container">
			<div class="title text-center">
				...
				<p class="wow fadeInUp" data-wow-delay=".2s">Experience the unprecedented convenience of booking with Bestay's <br> ecosystem</p>
			</div>
			<div class="list-prod">
				<div class="row">
					<div class="col-md-6 wow fadeInUp" data-wow-delay=".2s">
						<div class="item-prd">
							<div class="avarta"><a href=""> <img src="<?php echo __BASE_URL__ ?>/images/prd-1.png" class="img-fluid" alt=""></a></div>
							<div class="info">
								<h3><a href="">High-Performance Decentralized Platform </a></h3>
					...
					<div class="col-md-6 wow fadeInUp" data-wow-delay=".4s">
						<div class="item-prd">
							<div class="avarta"><a href=""> <img src="<?php echo __BASE_URL__ ?>/images/prd-2.png" class="img-fluid" alt=""></a></div>
							<div class="info">
								<h3><a href="">Best App for Booking Accommodation</a></h3>
								<ul class="list-inline">
									<li class="list-inline-item"><a href="" class="btn-grad">IOS</a></li>
									<li class="list-inline-item"><a href="" class="btn-grad">Android</a></li>
								</ul>
							</div>
						</div>
					</div>
					<div class="col-md-6 wow fadeInUp" data-wow-delay=".6s">
						<div class="item-prd">
							<div class="avarta"><a href=""> <img src="<?php echo __BASE_URL__ ?>/images/prd-3.png" class="img-fluid" alt=""></a></div>
							<div class="info">
								<h3><a href="">Secure, Convenient, Low-Cost</a></h3>
								<ul class="list-inline">
									<li class="list-inline-item"><a href="" class="btn-grad">IOS</a></li>
									<li class="list-inline-item"><a href="" class="btn-grad">Android</a></li>
								</ul>
					...
					<div class="col-md-6 wow fadeInUp" data-wow-delay=".8s">
						<div class="item-prd">
							<div class="avarta"><a href=""> <img src="<?php echo __BASE_URL__ ?>/images/prd-4.png" class="img-fluid" alt=""></a></div>
							<div class="info">
								<h3><a href="">BSY on Decentralized Exchanges</a></h3>
								<div class="btn-more"><a href="">Trade Now <i class="fa fa-caret-right"></i></a></div>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="slide-camp slide-page wow fadeInUp" data-wow-delay=".2s">
				<div class="item-slide">
					<div class="item-news"><div class="avarta"><a href=""> <img src="<?php echo __BASE_URL__ ?>/images/home-1.png" class="img-fluid" alt=""></a></div></div>
				</div>
				<div class="item-slide">
					<div class="item-news"><div class="avarta"><a href=""> <img src="<?php echo __BASE_URL__ ?>/images/home-2.png" class="img-fluid" alt=""></a></div></div>
				</div>
				<div class="item-slide">
					<div class="item-news"><div class="avarta"><a href=""> <img src="<?php echo __BASE_URL__ ?>/images/home-3.png" class="img-fluid" alt=""></a></div></div>
				</div>
				<div class="item-slide">
					<div class="item-news"><div class="avarta"><a href=""> <img src="<?php echo __BASE_URL__ ?>/images/home-2.png" class="img-fluid" alt=""></a></div></div>
				</div>
	...
	<section class="box-news">
		<div class="container">
			<div class="title text-center">
				...
				<p class="wow fadeInUp" data-wow-delay=".2s">Trade BSY, earn BSY with all bonus campaigns</p>
			</div>
